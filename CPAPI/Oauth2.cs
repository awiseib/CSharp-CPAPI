...
namespace CPAPI
{
    class Oauth2
    {
        ...
        private const string clientPemPath = @"D:\Code\Oauth2\clientPrivateKey.pem";
        private const string clientId = "eca_F3666424"; // The clientId uniquely identifies the client within the OAuth 2.0 server and will be different for each client. 
        private const string credential = "ajd0313b"; // The unique username 
        ...
        public async Task Oauth2_Main()
        {
            HttpClientHandler clientHandler = new()
            {
                // // The proxy and cerificate details below are used for troubleshooting with MITM proxy. 
            ...
            endpoint = "/iserver/contract/389094113/info-and-rules?isBuy=false";
            ...
            //endpoint = "/hmds/history?conid=265598&period=1d&bar=3600S&barType=Last";
